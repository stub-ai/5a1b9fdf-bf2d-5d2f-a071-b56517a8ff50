      ...
      <div className="bg-white rounded-lg shadow-md p-4 mb-4">
        ...
        <div className="flex justify-between items-center mt-4">
          <div className="flex space-x-2">
            <input type="checkbox" className="form-checkbox h-5 w-5 text-steelblue" onChange={() => toggleTaskCompletion('taskId')} />
            <button className="w-6 h-6 text-steelblue" onClick={() => deleteTask('taskId')}>
